...
<html lang="en">
    ...
    <body>
        ...
        <div class="logo">
            ...
            <a href="showPlace.do?id=<%=request.getSession().getAttribute("place")%>&floorId=<%=request.getSession().getAttribute("floorId")%>" >Adding Products | Go back</a><br>
        </div>
        <br>
        <div class="pad">
            <center>
                ...
                <tbody>
                    ...
                    <c:forEach var="product" items="${products}" varStatus="nr">
                        ...
                        <tr class="<%= rowodd ? "odd" : "even" %>">
                            ...
                            <td class="normal"></td>
                            <td><input value="Add" type="submit" class="btn btn-success" style="width:70px; margin-bottom:3px;" onclick="ajaxAddProduct('<%=request.getSession().getAttribute("place")%>', ${nr.count - 1}, '${product.name}', '${product.id}', 0);"/></td>
                            </div>
                        </tr>
                        <tr>
